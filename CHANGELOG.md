...
- GitHub Actions CI workflow (`.github/workflows/ci.yml`) that runs `mvn test` on pull requests and pushes to `master`.

### Changed

- Bumped `org.apache.commons:commons-lang3` from 3.14.0 to 3.18.0.
- cleanup tests, consistent write of temp output.
- added gh ci workflow for unit tests
